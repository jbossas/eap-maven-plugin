...
public class AddResourceTest {
    ...
    public void testCanAddCompositeResource(final AddResourceMojo addResourceMojo) throws Exception {
    ...
    public void testCanAddResource(final AddResourceMojo addResourceMojo) throws Exception {
        Assertions.assertDoesNotThrow(addResourceMojo::execute);
    ...
    public void testCanAddXaDataSource(final AddResourceMojo addResourceMojo) throws Exception {
        Assertions.assertDoesNotThrow(addResourceMojo::execute);
